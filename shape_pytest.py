...
def test_triangle():
    ...
    """
    x6y3z4 = Triangle(6, 3, 4)
    x5y5z5 = Triangle(5, 5, 5)


    # Test areas and perimeters
    assert x6y3z4.area() == 5.33
    assert x5y5z5.area() == 10.83
    assert x6y3z4.perimeter() == 13
    assert x5y5z5.perimeter() == 15
